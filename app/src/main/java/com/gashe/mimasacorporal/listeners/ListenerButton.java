package com.gashe.mimasacorporal.listeners;
...
import com.gashe.mimasacorporal.activities.MainActivity;
import com.gashe.mimasacorporal.activities.homeActivity;
import com.gashe.mimasacorporal.activities.resultadoIMCActivity;
import com.gashe.mimasacorporal.adapters.popupAdapter;
        ...
        switch (idButton){
            ...
            case R.id.buttonLogin:
                ...
                if(query.checkLogin(user)){
                    ...
                    editor.putInt("userId", query.getId(user));
                    editor.commit();
